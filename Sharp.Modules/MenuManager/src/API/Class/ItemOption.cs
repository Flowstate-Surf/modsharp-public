...
public class ItemOption(string display, DisableOption option, Action<IPlayerController, ItemOption>? onSelect)
{
    /// <summary>
    ...
    /// </summary>
    public Action<IPlayerController, ItemOption>? OnSelect { get; set; } = onSelect;
}
